...
#
"""
EDI commands for odahuflow cli
"""
import logging
import sys
import typing
...
from odahuflow.sdk.clients.edi import RemoteEdiClient
from odahuflow.sdk.clients.edi_aggregated import apply as edi_aggregated_apply
from odahuflow.sdk.clients.edi_aggregated import parse_resources_file, OdahuflowCloudResourceUpdatePair
...
def apply(client: RemoteEdiClient, file: str):
    """
    Create/Update Odahuflow resources on a EDI.\n
...
def delete(client: RemoteEdiClient, file: str):
    """
    Remove Odahuflow resources from a EDI.\n
    You should specify a path to file with resources.
    For now, CLI supports yaml and JSON file formats.
    Usage example:\n
...
def process_bulk_operation(edi_client: RemoteEdiClient, filename: str, is_removal: bool):
    ...
    result = edi_aggregated_apply(odahuflow_resources, edi_client, is_removal)
