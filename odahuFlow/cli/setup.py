...
VERSION_FILE = os.path.join(PACKAGE_ROOT_PATH, 'odahuflow/cli', 'version.py')
...
with open('requirements.txt') as f:
    requirements = [f'odahuflow-sdk=={extract_version()}'] + f.read().splitlines()
