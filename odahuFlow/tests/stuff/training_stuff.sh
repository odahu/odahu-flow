...
function setup() {
  ...
  jq ".spec.defaultImage = \"${DOCKER_REGISTRY}/odahuflow-pipeline-agent:${ODAHUFLOW_VERSION}\"" "${ODAHUFLOW_RESOURCES}/template.training_data_helper_ti.json" >"${ODAHUFLOW_RESOURCES}/training_data_helper_ti.json"
