...
*** Settings ***
Documentation       OdahuFlow's EDI operational check for bulk operations (with multiple resources)
...
Try to apply profile with syntax error
    [Documentation]  Try to apply profile with resources in incorrect order
    [Teardown]  Cleanup resources
    Apply bulk file and check parse errors  corrupted.odahuflow.yaml  is not valid JSON or YAML file
