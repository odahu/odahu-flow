...
...                 Run EDI deploy from model packaging and check model started  ${MP_COUNTER_MODEL}   ${MD_COUNTER_MODEL_1}   ${RES_DIR}/min-replicas-0.deployment.odahuflow.yaml  AND
...                 Run EDI deploy from model packaging and check model started  ${MP_COUNTER_MODEL}   ${MD_COUNTER_MODEL_2}   ${RES_DIR}/min-replicas-0.deployment.odahuflow.yaml  AND
...                 Run EDI deploy from model packaging and check model started  ${MP_FAIL_MODEL}      ${MD_FAIL_MODEL}        ${RES_DIR}/min-replicas-0.deployment.odahuflow.yaml
