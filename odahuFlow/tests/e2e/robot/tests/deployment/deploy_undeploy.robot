...
Check EDI deploy procedure
    ...
    Run EDI deploy from model packaging  ${MP_SIMPLE_MODEL}  ${MD_SIMPLE_MODEL}  ${RES_DIR}/simple-model.deployment.odahuflow.yaml
...
Update model deployment
    ...
    Run EDI apply from model packaging  ${MP_COUNTER_MODEL}  ${MD_SIMPLE_MODEL}  ${RES_DIR}/updated-simple-model.deployment.odahuflow.yaml
    Check model started  ${MD_SIMPLE_MODEL}
...
Deploy with custom memory and cpu
    ...
    [Teardown]  Cleanup resources
    Run EDI deploy from model packaging  ${MP_SIMPLE_MODEL}  ${MD_SIMPLE_MODEL}  ${RES_DIR}/custom-resources.deployment.odahuflow.yaml
