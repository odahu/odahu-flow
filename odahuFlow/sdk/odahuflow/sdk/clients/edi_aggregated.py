...
from odahuflow.sdk.clients.edi import RemoteEdiClient, WrongHttpStatusCode, AsyncRemoteEdiClient
...
def build_client(resource: OdahuflowCloudResourceUpdatePair, edi_client: RemoteEdiClient) -> typing.Optional[object]:
    """
