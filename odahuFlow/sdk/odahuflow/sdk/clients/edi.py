...
from odahuflow.sdk.definitions import EDI_VERSION
...
class RemoteEdiClient:
    ...
    def __init__(self,
                 base_url: str = odahuflow.sdk.config.EDI_URL,
                 token: Optional[str] = odahuflow.sdk.config.EDI_TOKEN,
    ...
    def _login(self, url: str, limit_stack=False):
        ...
        if self._refresh_token_exists:
            LOGGER.debug('Refresh token for %s has been found, trying to use it', odahuflow.sdk.config.EDI_ISSUING_URL)
    ...
    def _login_with_refresh_token(self):
        login_result = do_refresh_token(odahuflow.sdk.config.EDI_REFRESH_TOKEN, odahuflow.sdk.config.EDI_ISSUING_URL)
        if not login_result:
            raise IncorrectAuthorizationToken(
    ...
    def _refresh_token_exists(self):
        return odahuflow.sdk.config.EDI_REFRESH_TOKEN and odahuflow.sdk.config.EDI_ISSUING_URL
