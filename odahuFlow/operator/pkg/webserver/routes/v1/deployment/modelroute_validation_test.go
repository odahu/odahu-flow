...
import (
	"fmt"
	"github.com/odahu/odahu-flow/odahuFlow/operator/pkg/apis/deployment"
	"github.com/odahu/odahu-flow/odahuFlow/operator/pkg/apis/odahuflow/v1alpha1"
	dep_repository "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/repository/deployment"
	dep_k8s_repository "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/repository/deployment/kubernetes"
	"github.com/odahu/odahu-flow/odahuFlow/operator/pkg/utils"
	dep_route "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/webserver/routes/v1/deployment"
...
func (s *ModelRouteValidationSuite) TestNotExistsMirrorMD() {
	...
	err := s.validator.ValidatesAndSetDefaults(mr)
	s.g.Expect(err).To(HaveOccurred())
	s.g.Expect(err.Error()).To(ContainSubstring("modeldeployments.odahuflow.odahu.org \"not-exists\" not found"))
}
