...
import (
	...
	odahuflow_errors "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/errors"
	...
	conn_route "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/webserver/routes/v1/connection"
...
const (
	...
	connURI       = "git@github.com:odahu/odahuFlow.git"
	creds         = "bG9sCg=="
)
