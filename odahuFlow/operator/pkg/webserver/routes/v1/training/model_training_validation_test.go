...
import (
	...
	mt_repository "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/repository/training"
	mt_k8s_repository "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/repository/training/kubernetes"
	"github.com/odahu/odahu-flow/odahuFlow/operator/pkg/utils"
	train_route "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/webserver/routes/v1/training"
...
func (s *ModelTrainingValidationSuite) TestMtWrongDataType() {
	...
	s.g.Expect(err.Error()).Should(ContainSubstring(
		"odahuflow-test data binding has wrong data type. " +
