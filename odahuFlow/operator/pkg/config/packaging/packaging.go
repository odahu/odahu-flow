...
func init() {
	...
	viper.SetDefault(Namespace, "odahuflow-packaging")
	viper.SetDefault(PackagingIntegrationNamespace, "odahuflow")
	config.PanicIfError(viper.BindEnv(Namespace))

	viper.SetDefault(ServiceAccount, "odahuflow-model-packager")
