...
import (
	...
	md_config "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/config/deployment"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &v1alpha3_istio_api.VirtualService{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &odahuflowv1alpha1.ModelRoute{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileModelRoute) reconcileVirtualService(modelRouteCR *odahuflowv1alpha1.ModelRoute) (bool, error) {
