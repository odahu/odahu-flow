...
import (
	...
	dep_conf "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/config/deployment"
	...
	conn_http_repository "github.com/odahu/odahu-flow/odahuFlow/operator/pkg/repository/connection/http"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &odahuflowv1alpha1.ModelDeployment{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &odahuflowv1alpha1.ModelRoute{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &odahuflowv1alpha1.ModelDeployment{},
	})
	if err != nil {
...
func (r *ReconcileModelDeployment) reconcileStatus(
...
func (r *ReconcileModelDeployment) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	log := logf.Log.WithName(controllerName).WithValues(odahuflow.ModelDeploymentIDLogPrefix, request.Name)
