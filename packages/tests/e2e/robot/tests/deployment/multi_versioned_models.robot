...
Invoke two models
    ...
    ${res}=  Shell  odahuflowctl --verbose model invoke --base-url ${API_URL} --md ${MD_SIMPLE_MODEL_1} --json-file ${RES_DIR}/simple-model.request.json
         Should be equal  ${res.rc}  ${0}
         Should contain   ${res.stdout}  42
    ${res}=  Shell  odahuflowctl --verbose model invoke --base-url ${API_URL} --md ${MD_SIMPLE_MODEL_2} --json-file ${RES_DIR}/simple-model.request.json
         Should be equal  ${res.rc}  ${0}
         Should contain   ${res.stdout}  42
    ...
    ${res}=  Shell  odahuflowctl --verbose model invoke --base-url ${API_URL} --url-prefix /model/${MD_SIMPLE_MODEL_1} --json-file ${RES_DIR}/simple-model.request.json
         Should be equal  ${res.rc}  ${0}

    ${res}=  Shell  odahuflowctl --verbose model invoke --base-url ${API_URL} --url-prefix /model/${MD_SIMPLE_MODEL_2} --json-file ${RES_DIR}/simple-model.request.json
         Should be equal  ${res.rc}  ${0}

    ${res}=  Shell  odahuflowctl --verbose model invoke --base-url ${API_URL} --url-prefix /model/${MD_SIMPLE_MODEL_1} --json-file ${RES_DIR}/simple-model.request.json --jwt ${AUTH_TOKEN}
         Should be equal  ${res.rc}  ${0}
         Should contain   ${res.stdout}  42

    ${res}=  Shell  odahuflowctl --verbose model invoke --base-url ${API_URL} --url-prefix /model/${MD_SIMPLE_MODEL_2} --json-file ${RES_DIR}/simple-model.request.json --jwt ${AUTH_TOKEN}
         Should be equal  ${res.rc}  ${0}
         Should contain   ${res.stdout}  42
