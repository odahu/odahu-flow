...
...                 AND  StrictShell  ${RES_DIR}/setup/batch_setup_cleanup.sh setup --docker-registry ${DOCKER_REGISTRY}
Suite Teardown      Run Keywords
...                 StrictShell  ${RES_DIR}/setup/batch_setup_cleanup.sh cleanup --docker-registry ${DOCKER_REGISTRY}
