...
def test_edit(
    ...
    result = cli_runner.invoke(
        ...
        ["edit", "-f", entity_file, "-o", JSON_OUTPUT_FORMAT],
...
def test_edit_jsonpath(
    ...
    result = cli_runner.invoke(
        entity_test_data.click_group,
        ["edit", "-f", entity_file, "-o", f"{JSONPATH_OUTPUT_FORMAT}=[*].id"],
        obj=entity_test_data.entity_client,
    )
...
def test_edit_default_output_format(
    mocker: MockFixture,
    tmp_path,
    cli_runner: CliRunner,
    entity_test_data: EntityTestData,
...
def test_edit_wrong_output_format(
...
def test_create(
    ...
    result = cli_runner.invoke(
        entity_test_data.click_group,
        ["create", "-f", entity_file, "-o", JSON_OUTPUT_FORMAT],
        obj=entity_test_data.entity_client,
    )
...
def test_create_wrong_output_format(
    cli_runner: CliRunner, entity_test_data: EntityTestData
):
    result = cli_runner.invoke(
        entity_test_data.click_group,
...
def test_create_jsonpath(
    ...
    result = cli_runner.invoke(
        entity_test_data.click_group,
        ["create", "-f", entity_file, "-o", f"{JSONPATH_OUTPUT_FORMAT}=[*].id"],
        obj=entity_test_data.entity_client,
    )
...
def test_create_default_output_format(
    mocker: MockFixture,
    tmp_path,
    cli_runner: CliRunner,
    entity_test_data: EntityTestData,
