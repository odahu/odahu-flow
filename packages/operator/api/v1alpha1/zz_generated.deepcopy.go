...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (spec *ModelTrainingSpec) DeepCopyInto(out *ModelTrainingSpec) {
	*out = *spec
	out.Model = spec.Model
	if spec.CustomEnvs != nil {
		in, out := &spec.CustomEnvs, &out.CustomEnvs
		*out = make([]EnvironmentVariable, len(*in))
		copy(*out, *in)
	}
	if spec.HyperParameters != nil {
		in, out := &spec.HyperParameters, &out.HyperParameters
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if spec.EntrypointArguments != nil {
		in, out := &spec.EntrypointArguments, &out.EntrypointArguments
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if spec.Resources != nil {
		in, out := &spec.Resources, &out.Resources
		*out = new(ResourceRequirements)
		(*in).DeepCopyInto(*out)
	}
	if spec.Data != nil {
		in, out := &spec.Data, &out.Data
...
func (spec *ModelTrainingSpec) DeepCopy() *ModelTrainingSpec {
	if spec == nil {
		return nil
	}
