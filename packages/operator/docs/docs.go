...
var doc = `{
    ...
    "definitions": {
        "ConnectionReference": {
            ...
            "properties": {
                "connection": {
                    "description": "Next connection types are supported",
                    "type": "string"
                },
                "path": {
        ...
        "InferenceJob": {
            ...
            "properties": {
                "createdAt": {
                    "description": "CreatedAt describes when InferenceJob was launched",
                    "type": "string"
                },
                "id": {
                ...
                "status": {
                    "description": "Spec describes execution status of InferenceJob",
                    "type": "object",
                    "$ref": "#/definitions/InferenceJobStatus"
                },
                "updatedAt": {
                    "description": "CreatedAt describes when InferenceJob was updated (status was changed)",
                    "type": "string"
                }
            }
        },
