...
// sources:
// pkg/servicecatalog/inspectors/spec_templates/triton_oas_template.json
// DO NOT EDIT!
...
func triton_oas_templateJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "triton_oas_template.json", size: 4181, mode: os.FileMode(436), modTime: time.Unix(1611928638, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"triton_oas_template.json": &bintree{triton_oas_templateJson, map[string]*bintree{}},
}}
