...
func (mpc *ModelPackagingController) getMP(c *gin.Context) {
	...
	mp, err := mpc.packStorage.GetModelPackaging(mpID)
	if err != nil {
...
func (mpc *ModelPackagingController) getAllMPs(c *gin.Context) {
	...
	mpList, err := mpc.packStorage.GetModelPackagingList(
		filter.ListFilter(f),
		filter.Size(size),
		filter.Page(page),
	)
...
func (mpc *ModelPackagingController) createMP(c *gin.Context) {
	...
	if err := mpc.packStorage.CreateModelPackaging(&mp); err != nil {
...
func (mpc *ModelPackagingController) updateMP(c *gin.Context) {
	...
	if err := mpc.packStorage.UpdateModelPackaging(&mp); err != nil {
...
func (mpc *ModelPackagingController) saveMPResults(c *gin.Context) {
	...
	if err := mpc.packService.SaveModelPackagingResult(mpID, mpResult); err != nil {
...
func (mpc *ModelPackagingController) deleteMP(c *gin.Context) {
	...
	if err := mpc.packStorage.DeleteModelPackaging(mpID); err != nil {
...
func (mpc *ModelPackagingController) getModelPackagingLog(c *gin.Context) {
	...
	if err := mpc.packService.GetModelPackagingLogs(mpID, c.Writer, follow); err != nil {
