...
type ModelRouteController struct {
	routeService mr_repository.Repository
...
func (mrc *ModelRouteController) getMR(c *gin.Context) {
	...
	mr, err := mrc.routeService.GetModelRoute(mrID)
	if err != nil {
...
func (mrc *ModelRouteController) getAllMRs(c *gin.Context) {
	...
	mrList, err := mrc.routeService.GetModelRouteList(
		filter.Size(size),
		filter.Page(page),
	)
	if err != nil {
...
func (mrc *ModelRouteController) createMR(c *gin.Context) {
	...
	if err := mrc.routeService.CreateModelRoute(&mr); err != nil {
...
func (mrc *ModelRouteController) updateMR(c *gin.Context) {
	...
	if err := mrc.routeService.UpdateModelRoute(&mr); err != nil {
...
func (mrc *ModelRouteController) deleteMR(c *gin.Context) {
	...
	if err := mrc.routeService.DeleteModelRoute(mrID); err != nil {
