...
type ModelDeploymentController struct {
	deployStorage md_repository.Repository
...
func (mdc *ModelDeploymentController) getMD(c *gin.Context) {
	...
	md, err := mdc.deployStorage.GetModelDeployment(mdID)
	if err != nil {
...
func (mdc *ModelDeploymentController) getAllMDs(c *gin.Context) {
	...
	mdList, err := mdc.deployStorage.GetModelDeploymentList(
		filter.ListFilter(f),
		filter.Size(size),
		filter.Page(page),
	)
...
func (mdc *ModelDeploymentController) createMD(c *gin.Context) {
	...
	if err := mdc.deployStorage.CreateModelDeployment(&md); err != nil {
...
func (mdc *ModelDeploymentController) updateMD(c *gin.Context) {
	...
	if err := mdc.deployStorage.UpdateModelDeployment(&md); err != nil {
...
func (mdc *ModelDeploymentController) deleteMD(c *gin.Context) {
	...
	if err := mdc.deployStorage.DeleteModelDeployment(mdID); err != nil {
