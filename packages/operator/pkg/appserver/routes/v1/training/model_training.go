...
func (mtc *ModelTrainingController) getMT(c *gin.Context) {
	...
	mt, err := mtc.trainStorage.GetModelTraining(mtID)
	if err != nil {
...
func (mtc *ModelTrainingController) getAllMTs(c *gin.Context) {
	...
	mtList, err := mtc.trainStorage.GetModelTrainingList(
		filter.ListFilter(f),
		filter.Size(size),
		filter.Page(page),
	)
...
// @Param mt body training.training.ModelTraining true "Create a Model Training"
// @Tags Training
// @Accept  json
// @Produce  json
// @Success 201 {object} training.training.ModelTraining
// @Failure 400 {object} routes.HTTPResult
...
func (mtc *ModelTrainingController) createMT(c *gin.Context) {
	...
	if err := mtc.trainStorage.CreateModelTraining(&mt); err != nil {
...
// @Param mt body training.training.ModelTraining true "Update a Model Training"
// @Tags Training
// @Accept  json
// @Produce  json
// @Success 200 {object} training.training.ModelTraining
// @Failure 404 {object} routes.HTTPResult
// @Failure 400 {object} routes.HTTPResult
...
func (mtc *ModelTrainingController) updateMT(c *gin.Context) {
	...
	if err := mtc.trainStorage.UpdateModelTraining(&mt); err != nil {
		logMT.Error(err, fmt.Sprintf("Creation of the model training: %v", mt))
		c.AbortWithStatusJSON(routes.CalculateHTTPStatusCode(err), routes.HTTPResult{Message: err.Error()})
...
func (mtc *ModelTrainingController) saveMTResult(c *gin.Context) {
	...
	if err := mtc.trainService.SaveModelTrainingResult(mtID, mtResult); err != nil {
...
func (mtc *ModelTrainingController) deleteMT(c *gin.Context) {
	...
	if err := mtc.trainStorage.DeleteModelTraining(mtID); err != nil {
...
func (mtc *ModelTrainingController) getModelTrainingLog(c *gin.Context) {
	...
	if err := mtc.trainService.GetModelTrainingLogs(mtID, c.Writer, follow); err != nil {
