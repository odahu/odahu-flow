...
func (s *TestSuite) TestGetModelTraining() {
	...
	s.mockRepo.On("GetModelTraining", ctx, s.nilTx, enID).Return(en, nil)
...
func (s *TestSuite) TestGetModelTrainingList() {
	...
	s.mockRepo.
		On("GetModelTrainingList", ctx, s.nilTx, mock.AnythingOfType("filter.ListOption")).
		Return(ens, nil)
...
func (s *TestSuite) TestDeleteModelTraining() {
	...
	ctx := context.Background()
	s.mockRepo.On("DeleteModelTraining", ctx, s.nilTx, enID).Return(nil)
...
func (s *TestSuite) TestUpdateModelTraining_UpdatedAt() {
	as := assert.New(s.T())
...
func (s *TestSuite) TestCreateModelTraining_CreatedAt() {
	as := assert.New(s.T())
