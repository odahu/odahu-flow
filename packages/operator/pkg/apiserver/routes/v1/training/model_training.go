...
type ModelTrainingController struct {
	trainKubeClient mt_repository.Service
...
func (mtc *ModelTrainingController) saveMTResult(c *gin.Context) {
	...
	if err := mtc.trainKubeClient.SaveModelTrainingResult(mtID, mtResult); err != nil {
...
func (mtc *ModelTrainingController) getModelTrainingLog(c *gin.Context) {
	...
	if err := mtc.trainKubeClient.GetModelTrainingLogs(mtID, c.Writer, follow); err != nil {
