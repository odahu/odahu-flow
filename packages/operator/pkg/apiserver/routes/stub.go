...
import (
	_ "github.com/odahu/odahu-flow/packages/operator/pkg/apis/packaging" //nolint
	_ "github.com/odahu/odahu-flow/packages/operator/pkg/apis/training"  //nolint
)

// We have some data that doesn't involve in API HTTP API,
