...
func mapperRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "mapper.rego", size: 567, mode: os.FileMode(0664), modTime: time.Unix(1622817356, 0)}
...
func rolesRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "roles.rego", size: 91, mode: os.FileMode(0664), modTime: time.Unix(1622817356, 0)}
...
func ml_serversOdahu_ml_serverRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "ml_servers/odahu_ml_server.rego", size: 634, mode: os.FileMode(0664), modTime: time.Unix(1622817356, 0)}
...
func ml_serversTritonRego() (*asset, error) {
	...
	info := bindataFileInfo{name: "ml_servers/triton.rego", size: 896, mode: os.FileMode(0664), modTime: time.Unix(1622817356, 0)}
